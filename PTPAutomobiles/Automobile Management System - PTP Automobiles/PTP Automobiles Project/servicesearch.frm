...
Begin VB.Form servicesearch 
   ...
   Begin VB.ComboBox cmbSGivenBy 
      ...
      EndProperty
      Height          =   450
      ItemData        =   "servicesearch.frx":0000
      Left            =   10920
      List            =   "servicesearch.frx":0002
      TabIndex        =   13
      Top             =   6240
      Width           =   3495
   End
   ...
   Begin VB.Image i1 
      Height          =   10935
      Left            =   0
      Picture         =   "servicesearch.frx":0004
      Stretch         =   -1  'True
      Top             =   0
      Width           =   20295
   End
End
Attribute VB_Name = "servicesearch"
