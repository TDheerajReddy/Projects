...
Begin VB.Form sparepartssearch 
   Caption         =   "Update Spares Parts"
   ClientHeight    =   9810
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   18525
   ...
   Begin VB.CommandButton cmdSearch 
      ...
      Width           =   2415
   End
   Begin VB.CommandButton cmdCaluculate 
      Caption         =   "Calculate"
      BeginProperty Font 
         Name            =   "Times New Roman"
         Size            =   21.75
   ...
   Begin VB.ComboBox cmbSGivenBy 
      ...
      EndProperty
      Height          =   450
      ItemData        =   "sparepartssearch.frx":0000
      Left            =   10320
      List            =   "sparepartssearch.frx":0002
      TabIndex        =   13
      Top             =   6600
      Width           =   3495
   End
   ...
   Begin VB.Image i1 
      Height          =   10935
      Left            =   0
      Picture         =   "sparepartssearch.frx":0004
      Stretch         =   -1  'True
      Top             =   0
      Width           =   20295
   End
End
Attribute VB_Name = "sparepartssearch"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub cmdCaluculate_Click()
    Dim temp As Double
...
Private Sub cmdExit_Click()
    Load home
    home.Show
    sparepartssearch.Hide
    Unload sparepartssearch
End Sub
