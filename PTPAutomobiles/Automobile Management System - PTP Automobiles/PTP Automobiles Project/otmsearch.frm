...
Begin VB.Form otmsearch 
   ...
   Begin VB.ComboBox cmbOName 
      ...
      EndProperty
      Height          =   405
      ItemData        =   "otmsearch.frx":0000
      Left            =   10440
      List            =   "otmsearch.frx":000A
      TabIndex        =   1
   ...
   Begin VB.ComboBox cmbOGivenBy 
      ...
      EndProperty
      Height          =   450
      ItemData        =   "otmsearch.frx":0023
      Left            =   10440
      List            =   "otmsearch.frx":0025
      TabIndex        =   11
      Top             =   5400
      Width           =   3495
   End
   ...
   Begin VB.Image i1 
      Height          =   11040
      Left            =   0
      Picture         =   "otmsearch.frx":0027
      Stretch         =   -1  'True
      Top             =   0
      Width           =   20520
   End
End
Attribute VB_Name = "otmsearch"
...
Private Sub showRecord1()
    ...
    If recset.Fields("Order_Name").Value = "Spare Part" Then 'spare part
        Label13.Visible = True
        txtPartName.Visible = True
